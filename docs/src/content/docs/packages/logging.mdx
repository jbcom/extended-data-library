...
[![CI](https://github.com/extended-data-library/logging/workflows/CI/badge.svg)](https://github.com/extended-data-library/logging/actions)
...
- [GitHub Repository](https://github.com/extended-data-library/logging)
- [PyPI Package](https://pypi.org/project/lifecyclelogging/)
- [Changelog](https://github.com/extended-data-library/logging/blob/main/CHANGELOG.md)
