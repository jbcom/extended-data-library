...
description: Typed utilities for serialization, repository-aware file workflows, YAML and HCL interoperability, and transformation pipelines
---
...
<CardGrid>
  <Card title="Supported runtimes" icon="seti:python">
    Python 3.10 through 3.14.
  </Card>
  <Card title="Public API model" icon="seti:config">
  ...
  <Card title="Workflow-ready design" icon="seti:terminal">
    Explicit read/decode/write boundaries and plain-data HCL support make the
    package predictable inside larger automation systems.
  </Card>
</CardGrid>
...
That boundary is deliberate. It keeps local files, remote payloads, and larger
...
- [Source Code](https://github.com/jbcom/extended-data-library/tree/main/packages/extended-data-types)
